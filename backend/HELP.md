...
* [Spring Data R2DBC](https://docs.spring.io/spring-boot/3.5.11/reference/data/sql.html#data.sql.r2dbc)
* [JOOQ Access Layer](https://docs.spring.io/spring-boot/3.5.11/reference/data/sql.html#data.sql.jooq)
